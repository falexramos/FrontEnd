...
//document.querySelector('#btn-ingreso').addEventListener('click',iniciarSession);
        ...
        $.ajax({
            ...
            error: function (data) {
                ...
                if ((data.responseText == 'False')) {
                    ...
                    // console.log("Hello desde servicios:"+userActi);
...
function cerrarSession(){
    //onclick = "document.getElementById('id-logout').submit()"
